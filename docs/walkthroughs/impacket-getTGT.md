---
title: Impacket getTGT.py — Active Directory Kerberos Authentication Guide
date: 2024-12-03
difficulty: N/A
os: N/A
authors:
...
- TGT
- Active Directory
description: A technical guide on using Impacket getTGT.py to request a Kerberos Ticket
  Granting Ticket (TGT) using username/password, NTLM hashes, or AES keys in Active
  Directory environments.
image: assets/impacket-getTGT/impacket_gettgt_banner.png
---


![Impacket getTGT.py Banner](assets/impacket-getTGT/impacket_gettgt_banner.png)
