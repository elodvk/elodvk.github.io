---
title: Resource-Based Constrained Delegation (RBCD) — Attack Writeup & Mitigation
date: 2025-01-30
difficulty: N/A
os: N/A
authors:
...
- Delegation
- Security Mitigation
description: Technical overview of Resource-Based Constrained Delegation (RBCD) attacks
  in Active Directory. Details the exploitation process, shadow credentials integration,
  and mitigation guidelines.
image: assets/rbcd/rbcd_banner.png
---


![Resource-Based Constrained Delegation (RBCD) Banner](assets/rbcd/rbcd_banner.png)
